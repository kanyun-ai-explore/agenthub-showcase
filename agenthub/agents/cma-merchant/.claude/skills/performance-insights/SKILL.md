...
<!--
  ...
  merchant-agent/skills/performance-insights/SKILL.md — unmodified. Apache License 2.0
  (see repo root LICENSE / NOTICE). Tool names below (get_pricing_context,
  stage_price_update, etc.) refer to this deployment's mcp__merchant__<name>
  tools, delivered over the merchant stdio MCP connection.
-->
