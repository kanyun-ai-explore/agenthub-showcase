...
<!--
  ...
  shopping-agent/skills/memory-personalization/SKILL.md — unmodified. Apache
  License 2.0 (see repo root LICENSE / NOTICE). Tool names below
  (save_memory, recall_memories) refer to this deployment's
  mcp__storefront__<name> tools, delivered over the storefront stdio MCP
  connection.
-->
